...
public class Ventre extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        preced.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent popupwindow = new Intent(Ventre.this,MainActivity.class);
        ...
        suiv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent popupwindow = new Intent(Ventre.this,jambe.class);
                startActivity(popupwindow);
            }
        });
        ...
        jr2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent popupwindow = new Intent(Ventre.this,Jour2_exercices.class);
                startActivity(popupwindow);
            }
        });
...
jr3 = findViewById(R.id.card1);
        jr3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent popupwindow = new Intent(Ventre.this,Ventre_exercices.class);
                startActivity(popupwindow);
            }
        });
        ...
        jr4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent popupwindow = new Intent(Ventre.this,Break_day.class);
                startActivity(popupwindow);
            }
        });
