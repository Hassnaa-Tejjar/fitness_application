    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        suiv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent popupwindow = new Intent(Programme.this,Ventre.class);
        ...
        jr4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent popupwindow = new Intent(Programme.this,Break_day_Pro.class);
                startActivity(popupwindow);
            }
        });
        ...
        jr2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent popupwindow = new Intent(Programme.this,Jour2_exercices_Pro.class);
                startActivity(popupwindow);
            }
        });
