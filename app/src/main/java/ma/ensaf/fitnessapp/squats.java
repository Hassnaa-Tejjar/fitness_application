    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        preced.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent window = new Intent(squats.this,squats.class);
        ...
        passer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent window = new Intent(squats.this,Break.class);
                startActivity(window);
            }
        });
        rt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent window = new Intent(squats.this,jour1_Exerc_Complet.class);
                startActivity(window);
            }
        });
