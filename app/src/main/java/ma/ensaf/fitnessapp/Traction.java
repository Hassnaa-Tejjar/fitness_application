...
public class Traction extends AppCompatActivity {
    ProgressBar p1;
    int counter=0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        preced.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent window = new Intent(Traction.this,Crunch2.class);
        ...
        passer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent window = new Intent(Traction.this,Break5.class);
                startActivity(window);
            }
        });
