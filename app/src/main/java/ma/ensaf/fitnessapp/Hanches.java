...
public class Hanches extends AppCompatActivity {
    ProgressBar p1;
    int counter=0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hanches);
        start=findViewById(R.id.start);
        stop=findViewById(R.id.stop);
        t1=findViewById(R.id.t1);
        rt=findViewById(R.id.retour);
        ...
        preced.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent window = new Intent(Hanches.this,squats.class);
        ...
        passer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent window = new Intent(Hanches.this,Break1.class);
                startActivity(window);
            }
        });
        rt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent window = new Intent(Hanches.this,Break.class);
                startActivity(window);
            }
        });
