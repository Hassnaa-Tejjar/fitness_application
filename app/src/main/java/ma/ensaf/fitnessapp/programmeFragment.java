    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        jr1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getActivity(), jour1_Exerc_Complet.class);
                startActivity(intent);
            }
        });
        suiv = view.findViewById(R.id.suiv);
        ...
        jr4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent popupwindow = new Intent(getActivity(),Break_day_Pro.class);
                startActivity(popupwindow);
            }
        });
        ...
        jr30.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent popupwindow = new Intent(getActivity(),jour1_Exerc_Complet.class);
                startActivity(popupwindow);
            }
        });
        ...
        jr2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent popupwindow = new Intent(getActivity(),Jour2_exercices_Pro.class);
                startActivity(popupwindow);
            }
        });
