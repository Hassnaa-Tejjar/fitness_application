...
public class Crunch3 extends AppCompatActivity {
    ProgressBar p1;
    int counter=0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_crunch3);
        ...
        preced.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent window = new Intent(Crunch3.this,Traction.class);
        ...
        passer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent window = new Intent(Crunch3.this,fin.class);
                startActivity(window);
            }
        });
